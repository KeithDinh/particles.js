var grabLineLinkedColor = hexToRgb("#fff700"); // default: "rgba(" + r.r + "," + r.g + "," + r.b + "," + n + ")"
// if div in parent and parent have padding, X is horizontal padding, and Y is vertical padding
var paddingOffsetParent = { X: 0, Y: 0 };
/* -----------------------------------------------
...
var pJS = function (e, t) {
  ...
  // Kiet - set height of the canvas to the about container height
  var container_about = document.getElementById("about");
  a.style.height = container_about.offsetHeight + "px";
  this.pJS = {
          ...
          0 <
            (n =
              ...
              i /
                ...
                y.interactivity.modes.grab.distance) &&
          (y.particles.line_linked.color_rgb_line,
          (y.canvas.ctx.strokeStyle =
            "rgba(" +
            grabLineLinkedColor.r +
            "," +
            grabLineLinkedColor.g +
            "," +
            grabLineLinkedColor.b +
            "," +
            n +
            ")"),
          (y.canvas.ctx.lineWidth = y.particles.line_linked.width),
      ...
      "window" == y.interactivity.detect_on
        ...
        (y.interactivity.events.onhover.enable ||
          ...
          (y.interactivity.el.addEventListener("mousemove", function (e) {
            ...
            (a =
              y.interactivity.el == window
                ? ((t = e.offsetX), e.offsetY - paddingOffsetParent.Y)
                : ((t = e.offsetX || e.pageX), e.offsetY || e.pageY)),
